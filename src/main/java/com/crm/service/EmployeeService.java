...
public class EmployeeService {
    ...
    public List<EmployeeDto> getEmployee(int pageNo, int pageSize,  String sortBy, String sortDir) {
       Sort sort =  sortDir.equalsIgnoreCase("asc")?Sort.by(sortBy).ascending():Sort.by(sortBy).descending();
        ...
        List<Employee> employees = all.getContent(); //getContent() it will convert Page<Employee> into List<Employee>
    ...
    EmployeeDto mapToDto(Employee employee){
        //mapToDto method converts all the Entity class object content into Dto class object
...
//        return dto;
    ...
    Employee mapToEntity(EmployeeDto dto) {
        //mapToEntity method converts all the Dto class object content into Entity class object
